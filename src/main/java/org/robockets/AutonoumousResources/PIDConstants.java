...
/**
 * <p>https://docs.wpilib.org/en/stable/docs/software/pathplanning/system-identification/identification-routine.html</p>
 * <p>https://docs.wpilib.org/en/stable/docs/software/pathplanning/system-identification/identification-routine.html</p>
 * <p>https://docs.wpilib.org/en/stable/docs/software/pathplanning/system-identification/identification-routine.html</p>
 * <p>https://docs.wpilib.org/en/stable/docs/software/pathplanning/system-identification/identification-routine.html</p>
 * <p>https://docs.wpilib.org/en/stable/docs/software/pathplanning/system-identification/identification-routine.html</p>
...
public class PIDConstants {
    ...
    public static double METERS_TO_TICKS(double meters) {
        double circumference = Math.PI * 2.0 * r_wheel_meters;
        return (meters / circumference) * GearRatios.drivetrain * TICKS_PER_REV;
